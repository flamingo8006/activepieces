...
const systemPropValidators: {
    ...
    [AppSystemProp.DGIST_SSO_ENABLED]: booleanValidator,
    [AppSystemProp.DGIST_SSO_AUTHORIZE_URL]: urlValidator,
    [AppSystemProp.DGIST_SSO_JWKS_URL]: urlValidator,
    [AppSystemProp.DGIST_SSO_ISSUER]: stringValidator,
    [AppSystemProp.DGIST_SSO_AUDIENCE]: stringValidator,
    [AppSystemProp.DGIST_SSO_CLIENT_ID]: stringValidator,
