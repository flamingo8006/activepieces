...
export enum AppSystemProp {
    ...
    DGIST_SSO_ENABLED = 'DGIST_SSO_ENABLED',
    DGIST_SSO_AUTHORIZE_URL = 'DGIST_SSO_AUTHORIZE_URL',
    DGIST_SSO_JWKS_URL = 'DGIST_SSO_JWKS_URL',
    DGIST_SSO_ISSUER = 'DGIST_SSO_ISSUER',
    DGIST_SSO_AUDIENCE = 'DGIST_SSO_AUDIENCE',
    DGIST_SSO_CLIENT_ID = 'DGIST_SSO_CLIENT_ID',
    EDITION = 'EDITION',
